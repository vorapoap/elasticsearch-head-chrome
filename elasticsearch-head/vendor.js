                ...
                switch (attr) {
                    ...
                    default:
                        if (attr.indexOf("on") === 0 && $.isFunction(obj[attr])) {
                            $.event.add(
                                el,
                                attr.substr(2).replace(/^[A-Z]/, function (a) {
...
(function () {
    ...
    if (R.svg) {
        ...
        var addGradientFill = function (o, gradient, SVG) {
            ...
            $(
                el,
                type == "radial" ? { fx: fx, fy: fy } : { x1: vector[0], y1: vector[1], x2: vector[2], y2: vector[3] }
            );
                    ...
                    switch (att) {
                        ...
                        case "scale":
                            ...
                            o.scale(
                                +xy[0] || 1,
                                +xy[1] || +xy[0] || 1,
                                isNaN(toFloat(xy[2])) ? null : +xy[2],
                                isNaN(toFloat(xy[3])) ? null : +xy[3]
                            );
                            break;
                        case fillString:
                            ...
                            if (!clr.error) {
                                ...
                                ({ circle: 1, ellipse: 1 }[has](o.type) || Str(value).charAt() != "r") &&
            ...
            tuneText = function (el, params) {
                ...
                var a = el.attrs,
                    ...
                    fontSize = node.firstChild
                        ? toInt(doc.defaultView.getComputedStyle(node.firstChild, E).getPropertyValue("font-size"), 10)
                        : 10;
    ...
    if (R.vml) {
        ...
        setFillAndStroke = function (o, params) {
            ...
            params["font-family"] &&
                (s.fontFamily = '"' + params["font-family"][split](",")[0][rp](/^['"]+|['"]+$/g, E) + '"');
            ...
            if (
                ...
                if (fill.on && params.fill) {
                    ...
                    if (isURL) {
                        ...
                        if (
                            ...
                            addGradientFill(res, params.fill)
                        ) {
                            a.fill = "none";
                ...
                (params.stroke == "none" || stroke.on == null || params.stroke == 0 || params["stroke-width"] == 0) &&
                    (stroke.on = false);
            ...
            if (res.type == "text") {
                ...
                res.node.string &&
                    (res.paper.span.innerHTML = Str(res.node.string)
                        [rp](/</g, "&#60;")
                        [rp](/&/g, "&#38;")
                        [rp](/\n/g, "<br>"));
        ...
        elproto.attr = function (name, value) {
            ...
            if (params) {
                ...
                if (
                    params.gradient &&
                    ({ circle: 1, ellipse: 1 }[has](this.type) || Str(params.gradient).charAt() != "r")
                ) {
    ...
    if (
        ...
        ((version && version[1] < 4) || navigator.platform.slice(0, 2) == "iP")
    ) {
    ...
    var preventDefault = function () {
        ...
        dragMove = function (e) {
            ...
            while (j--) {
                ...
                y += scrollY;
                dragi.move &&
                    dragi.move.call(dragi.move_scope || dragi.el, x - dragi.el._drag.x, y - dragi.el._drag.y, x, y, e);
            }
        },
        dragUp = function (e) {
        ...
        getLengthFactory = function (istotal, subpath) {
            return function (path, length, onlystart) {
                ...
                point = istotal
                    ...
                    : subpath
                    ? subpaths
                    : R.findDotsAtSegment(x, y, p[1], p[2], p[3], p[4], p[5], p[6], 1);
            ...
            for (var l = 0; l < animationElements[length]; l++) {
                ...
                if (time < ms) {
                                    ...
                                    switch (attr) {
                                        ...
                                        case "scale":
                                            now = [
                                                ...
                                                2 in to[attr] ? to[attr][2] : E,
                                                3 in to[attr] ? to[attr][3] : E,
                                            ][join](S);
                                            break;
                                        case "clip-rect":
                                            now = [];
                    ...
                    if (to.along) {
                        ...
                        that.translate(
                            diff.sx - (diff.x || 0) + point.x - diff.sx,
                            diff.sy - (diff.y || 0) + point.y - diff.sy
                        );
                        to.rot && that.rotate(diff.r + point.alpha, point.x, point.y);
                    }
                    ...
                    switch (availableAnimAttrs[attr]) {
                        ...
                        case "csv":
                            ...
                            switch (attr) {
                                ...
                                case "rotation":
                                    from[attr] =
                                        from2[1] == values[1] && from2[2] == values[2]
                                            ? from2
                                            : [0, values[1], values[2]];
        ...
        if (!animateable) {
            ...
            for (i = 0, ii = attrs[length]; i < ii; i++) {
                keyframesRun(
                    ...
                    element,
                    (ms / 100) * attrs[i].key,
                    (ms / 100) * ((attrs[i - 1] && attrs[i - 1].key) || 0),
                    attrs[i - 1] && attrs[i - 1].value.callback
                );
            }
                ...
                if (font.glyphs[has](glyph)) {
                    ...
                    fontcopy.glyphs[glyph] = {
                        ...
                        d:
                            path.d &&
                            "M" +
                                path.d[rp](/[mlcxtrv]/g, function (command) {
    ...
    paperproto.print = function (x, y, string, font, size, origin, letter_spacing) {
        ...
        if (font) {
            ...
            for (var i = 0, ii = letters[length]; i < ii; i++) {
                ...
                curr &&
                    curr.d &&
                    out[push](this.path(curr.d).attr({ fill: "#000", stroke: "none", translation: [shift, 0] }));
            }
    ...
    R.format = function (token, params) {
        ...
        token &&
            R.is(token, string) &&
            args[length] - 1 &&
            (token = token[rp](formatrg, function (str, i) {
...
(function () {
    ...
    Raphael.fn.g.flower = function (cx, cy, r, n) {
        ...
        for (var i = 1; i < n * 2 + 1; i++) {
            ...
            points = points.concat([
                +(cx + R * Math.sin((i * Math.PI) / n)).toFixed(3),
                +(cy + R * Math.cos((i * Math.PI) / n)).toFixed(3),
            ]);
        }
        points.push("z");
    ...
    Raphael.fn.g.arrow = function (cx, cy, r) {
        return this.path(
            "M".concat(
                ...
                cy - r * 0.4,
                "l",
                [r * 0.6, 0, 0, -r * 0.4, r, r * 0.8, -r, r * 0.8, 0, -r * 0.4, -r * 0.6, 0],
                "z"
            )
        );
    };
    ...
    Raphael.fn.g.tag = function (x, y, text, angle, r) {
        ...
        res.update = function () {
            ...
            angle > 90 &&
                angle < 270 &&
                this[1].attr({ x: x - r - d - bb.width / 2, y: y, rotation: [180 + angle, x, y] });
            return this;
        };
        res.update();
        return res;
    ...
    Raphael.fn.g.popupit = function (x, y, set, dir, size) {
        ...
        return this.path(p)
            ...
            .insertBefore(set.node ? set : set[0]);
    };
    ...
    Raphael.fn.g.labelit = function (set) {
        ...
        return this.rect(bb.x - r / 2, bb.y - r / 2, bb.width + r, bb.height + r, r)
    ...
    Raphael.fn.g.drop = function (x, y, text, size, angle) {
        ...
        res.push(
            this.path([
                ...
                y - size * 0.7,
                "z",
            ]).attr({ fill: "#000", stroke: "none", rotation: [22.5 - angle, x, y] })
        );
        angle = ((angle + 90) * Math.PI) / 180;
        res.push(
            this.text(x + size * Math.sin(angle), y + size * Math.cos(angle), text)
                .attr(this.g.txtattr)
                .attr({ "font-size": (size * 12) / 30, fill: "#fff" })
        );
        res.drop = res[0];
        res.text = res[1];
        return res;
    ...
    Raphael.fn.g.blob = function (x, y, text, angle, size) {
        ...
        res.push(
            this.text(x + size * Math.sin(angle * rad), y + size * Math.cos(angle * rad) - fontSize / 2, text)
                .attr(this.g.txtattr)
                .attr({ "font-size": fontSize, fill: "#fff" })
        );
        res.update = function (X, Y, withAnimation) {
            X = X || x;
            Y = Y || y;
            var bb = this[1].getBBox(),
                ...
                ry = h / 2,
                k = -Math.sqrt(
                    Math.abs(rx * rx * ry * ry - rx * rx * dy * dy - ry * ry * dx * dx) /
            ...
            if (withAnimation) {
                this.animate(
                    { x: cx, y: cy, path: ["M", x, y, "L", x1, y1, "A", rx, ry, 0, 1, 1, x2, y2, "z"].join(",") },
                    500,
                    ">"
                );
            } else {
                this.attr({
                    x: cx,
                    y: cy,
                    path: ["M", x, y, "L", x1, y1, "A", rx, ry, 0, 1, 1, x2, y2, "z"].join(","),
                });
            }
            return this;
        };
    ...
    Raphael.fn.g.colorValue = function (value, total, s, b) {
        return "hsb(" + [mmin((1 - value / total) * 0.4, 1), s || 0.75, b || 0.75] + ")";
    };
    ...
    Raphael.fn.g.snapEnds = function (from, to, steps) {
        ...
        function round(a) {
            return Math.abs(a - 0.5) < 0.25 ? ~~a + 0.5 : Math.round(a);
        }
        var d = (t - f) / steps,
            r = ~~d,
            R = r,
        ...
        f = round((from - (i > 0 ? 0 : 0.5)) * Math.pow(10, i)) / Math.pow(10, i);
    ...
    Raphael.fn.g.axis = function (x, y, length, from, to, steps, orientation, labels, type, dashsize) {
        ...
        var path =
                type == "|" || type == " "
                    ...
                    ? ["M", x + 0.5, y, "l", 0, -length]
                    : ["M", x, y + 0.5, "l", length, 0],
        ...
        if (+orientation == 1 || +orientation == 3) {
            ...
            while (Y >= y - length) {
                type != "-" &&
                    ...
                    (path = path.concat([
                        "M",
                        x - (type == "+" || type == "|" ? dashsize : !(orientation - 1) * dashsize * 2),
                        Y + 0.5,
                        "l",
                        dashsize * 2 + 1,
                        0,
            ...
            while (X <= x + length) {
                type != "-" &&
                    ...
                    (path = path.concat([
                        "M",
                        X + 0.5,
                        y - (type == "+" ? dashsize : !!orientation * dashsize * 2),
                        "l",
                        0,
                        dashsize * 2 + 1,
                    ]));
    ...
    for (var i = 0; i < len; i++) {
        ...
        for (var j = 0; j < (multi || 1); j++) {
            var h = Math.round((multi ? values[j][i] : values[i]) * Y),
                ...
                bar = this.g
                    .finger(Math.round(X + barwidth / 2), top + h, barwidth, h, true, type)
    ...
    if (!opts.stacked) {
        for (var i = 0; i < len; i++) {
            for (var j = 0; j < (multi || 1); j++) {
                var cover;
                covers.push(
                    (cover = this.rect(Math.round(X), y + barvgutter, barwidth, height - barvgutter).attr(this.g.shim))
                );
        ...
        if (opts.stacked) {
            for (var i = 0; i < len; i++) {
                ...
                for (var j = 0; j < (multi || 1); j++) {
                    ...
                    if (j == 0) {
                        ...
                        L = paper.g.text(
                            bars[j][i].x,
                            isBottom ? y + height - barvgutter / 2 : bars[j][i].y - 10,
                            label
                        );
                        if (rotate) {
                            L.rotate(90);
            ...
            for (var i = 0; i < len; i++) {
                for (var j = 0; j < (multi || 1); j++) {
                    ...
                    var label = paper.g.labelise(
                        multi ? labels[0] && labels[0][i] : labels[i],
                        multi ? values[0][i] : values[i],
                        total
                    );
                    L = paper.g.text(
                        bars[0][i].x,
                        isBottom ? y + 5 + height - barvgutter / 2 : bars[0][i].y - 10,
                        label
                    );
                    if (rotate) {
                        L.rotate(90);
    ...
    for (var i = 0; i < len; i++) {
        ...
        for (var j = 0; j < (multi || 1); j++) {
            var val = multi ? values[j][i] : values[i],
                bar = this.g
                    .finger(x, Y + barheight / 2, Math.round(val * X), barheight - 1, false, type)
                    .attr({ stroke: "none", fill: colors[multi ? j : i] });
            if (multi) {
                bars[j].push(bar);
            } else {
        ...
        if (opts.stacked) {
            ...
            for (var s = 0, ss = stack.length; s < ss; s++) {
                ...
                bar.x = x + val;
                covers.push(
                    (cover = this.rect(x + size * X, bar.y - bar.h / 2, bar.value * X, barheight).attr(this.g.shim))
                );
                cover.bar = bar;
                size += bar.value;
            }
    ...
    chart.label = function (labels, isRight) {
        ...
        for (var i = 0; i < len; i++) {
            for (var j = 0; j < multi; j++) {
                var label = paper.g.labelise(
                    multi ? labels[j] && labels[j][i] : labels[i],
                    multi ? values[j][i] : values[i],
                    total
                );
                ...
                this.labels.push(
                    (L = paper.g
                        .text(X, bars[i * (multi || 1) + j].y, label)
                        .attr({ "text-anchor": A })
    ...
    function drawAxis(ax) {
        ...
        +ax[1] &&
            (ax[1] = paper.g.axis(
                ...
                3,
                opts.axisylabels || null,
                opts.axisytype || "t"
            ));
        +ax[2] &&
            (ax[2] = paper.g.axis(
                x + gutter,
                y + height - gutter + maxR,
                width - 2 * gutter,
                minx,
                maxx,
                opts.axisxstep || Math.floor((width - 2 * gutter) / 20),
...
Raphael.fn.g.linechart = function (x, y, width, height, valuesx, valuesy, opts) {
    ...
    for (i = 0, ii = valuesy.length; i < ii; i++) {
        if (opts.shade) {
            shades.push(this.path().attr({ stroke: "none", fill: colors[i], opacity: opts.nostroke ? 1 : 0.3 }));
        }
    ...
    for (i = 0, ii = valuesy.length; i < ii; i++) {
        ...
        for (var j = 0, jj = valuesy[i].length; j < jj; j++) {
            ...
            (Raphael.is(sym, "array") ? sym[j] : sym) &&
                symset.push(
                    this.g[Raphael.fn.g.markers[this.raphael.is(sym, "array") ? sym[j] : sym]](
                        X,
                        Y,
                        (opts.width || 2) * 3
                    ).attr({ fill: colors[i], stroke: "none" })
                );
            if (opts.smooth) {
                if (j && j != jj - 1) {
            ...
            shades[i].attr({
                path: path
                    .concat([
                        ...
                        y + height - gutter,
                        "L",
                        x + gutter + ((valuesx[i] || valuesx[0])[0] - minx) * kx,
                        y + height - gutter,
                        "z",
                    ])
                    .join(","),
        ...
        !opts.nostroke &&
            line.attr({
                path: path.join(","),
                "clip-rect": [x + gutter, y + gutter, width - 2 * gutter, height - 2 * gutter].join(","),
            });
    }
    ...
    function createColumns(f) {
        ...
        for (i = 0; i < ii; i++) {
            ...
            f
                ...
                : cvrs.push(
                      (C = that
                          .rect(X - 1, y, Math.max(w + 1, 1), height)
                          .attr({ stroke: "none", fill: "#000", opacity: 0 }))
                  );
            C.values = [];
            C.symbols = that.set();
            C.y = [];
...
Raphael.fn.g.piechart = function (cx, cy, r, values, opts) {
    ...
    if (len == 1 || single == true) {
        for (var i = 0; i < len; i++) {
            ...
            series.push(
                this.circle(cx, cy, radius).attr({
                    fill: (opts.colors && opts.colors[i]) || this.g.colors[i],
            ...
            covers.push(
                this.circle(cx, cy, radius)
                    .attr({ href: opts.href ? opts.href[i] : null })
                    .attr(this.g.shim)
            );
            values[i] = {
                value: values[i],
        ...
        for (i = 0; i < len; i++) {
            ...
            var p = this.path(opts.init ? ipath : path).attr({
                fill: (opts.colors && opts.colors[valueOrder]) || this.g.colors[valueOrder] || "#666",
                stroke: opts.stroke || "#fff",
                "stroke-width": opts.strokewidth == null ? 1 : opts.strokewidth,
                "stroke-linejoin": "round",
            });
        ...
        for (var i = 0; i < len; i++) {
            ...
            chart.labels[i].push(
                (txt = paper
                    ...
                    .attr(paper.g.txtattr)
                    .attr({ fill: opts.legendcolor || "#000", "text-anchor": "start" }))
            );
    ...
    drp._parse = function parse(v) {
        ...
        function procTerm(term) {
            ...
            if (m[1]) {
                ...
                switch (m[1]) {
                    case "now":
                        return { start: now, end: now, now: now };
                    case "today":
                        return dra(2, 0);
                    case "thisweek":
                        return dra(2, 0, 7);
